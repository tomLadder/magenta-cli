...
DOWNLOAD_URL="https://github.com/$REPO/releases/download/$TAG/magenta-$TARGET"

echo "Downloading magenta $TAG for $TARGET..."
TMPFILE="$(mktemp)"
...
echo "magenta $TAG installed successfully! Run 'magenta --help' to get started."
